...
with open('mean_image.binaryproto') as f:
...
net = caffe.Net('Caffenet_1_2_3_4_5_8_Deploy.prototxt',
                'Caffenet_1_2_3_4_5_8.caffemodel',
		caffe.TEST)
...
'''
#Reading image paths
test_img_paths = [img_path for img_path in glob.glob("./teste2/*jpg")]
...
'''
with open("jetson-tk1.csv","w") as f:
    f.write("id,label\n")
